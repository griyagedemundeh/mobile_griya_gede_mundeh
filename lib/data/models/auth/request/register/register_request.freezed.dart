...
class _$RegisterRequestImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RegisterRequest(fullName: $fullName, phoneNumber: $phoneNumber, email: $email, password: $password, passwordConfirm: $passwordConfirm, address: $address)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, fullName, phoneNumber, email,
      password, passwordConfirm, address);
...
abstract class _RegisterRequest implements RegisterRequest {
  const factory _RegisterRequest(
      ...
      required final String address}) = _$RegisterRequestImpl;
