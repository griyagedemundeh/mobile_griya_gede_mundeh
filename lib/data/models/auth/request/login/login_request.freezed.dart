...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userIdentifier, String password});
}
...
class _$LoginRequestImpl with DiagnosticableTreeMixin implements _LoginRequest {
  const _$LoginRequestImpl(
      {required this.userIdentifier, required this.password});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginRequest(userIdentifier: $userIdentifier, password: $password)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('userIdentifier', userIdentifier))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userIdentifier, password);
